...
const isCwdInScope = isPackageExists('@markterence/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@markterence/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@markterence/eslint-config'
